  ...
  _createClass(Pie, [{
    ...
    value: function checkSize() {
      ...
      if (this.props.scaleToFit) {
        ...
        console.log(width + 'x' + height + ' => ' + this.state.scale);
        console.log(this.state.scale);
        console.log(bbox);
        // Undo existing scale to know "true" size.
        bbox.width /= this.state.scale;
        bbox.height /= this.state.scale;
        console.log(bbox);
        var factor = void 0;
        if (bbox.width > width) {
          factor = bbox.width / width / 100;
          var wide = { scale: factor };
          console.log('wide: ' + factor);
          this.setState(wide);
        }
        if (bbox.height > height) {
          var heightFactor = bbox.height / height / 100;
          factor = Math.min(factor, heightFactor);
          var tall = { scale: factor };
          console.log('tall: ' + factor);
          this.setState(tall);
        }
      }
    }
    ...
    value: function renderClipPath() {
      ...
      var cx = _props4.cx;
      var cy = _props4.cy;
      var maxRadius = _props4.maxRadius;
    ...
    value: function renderLabels(sectors) {
      ...
      var labelLine = _props5.labelLine;
      var valueKey = _props5.valueKey;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Layer2.default,
        { className: layerClass, ref: function ref() {
            return _this4.checkSize();
          } },
        _react2.default.createElement(
          'g',
          { className: 'recharts-pie-scale', transform: 'scale(' + scale + ')' },
          this.renderClipPath(),
          _react2.default.createElement(
            'g',
